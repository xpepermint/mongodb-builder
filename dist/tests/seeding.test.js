...
ava_1["default"].beforeEach(function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = t.context;
                return [4, mongodb_1.MongoClient.connect('mongodb://localhost:27017/test', { useNewUrlParser: true })];
            case 1:
                _a.client = _b.sent();
...
ava_1["default"].afterEach(function (t) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, t.context.client.db('test').dropDatabase()];
            case 1:
                _a.sent();
                return [2];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                seeder.add({
                    perform: function (context) { return count = count + context.val; }
                });
                seeder.add({
                    perform: function (context) { return count = count + context.val; }
                });
